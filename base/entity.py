...
class Coin:
    ...
    def gen_plot_filename(self, config_name):
        file_path = os.getcwd()
        plot_filename = file_path + '/plot_' + self.name + '_' + config_name + '.txt'
        return plot_filename

    def gen_depth_filename(self):
        file_path = os.getcwd()
        depth_filename = file_path + '/' + self.name + '_depth.txt'
